...
**Languages:**  
`JavaScript` `TypeScript` `Python` `PHP` `Bash`

**Frontend:**  
`Vue 2/3` `Tailwind` `SCSS`

**Backend:**  
`Node.js` `NestJS` `FastAPI` `Express` `CakePHP` `Laravel`

**AI / ML / Agents:**  
`Ollama` `AI Agent Systems` `Docling` `OCR Pipelines`

**Infrastructure:**  
`Docker` `Docker Compose` `Nginx` `Teleport` `Netdata`
